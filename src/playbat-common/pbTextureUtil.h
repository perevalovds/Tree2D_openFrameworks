...
public:
	...
	static void drawQuads( vector<ofPoint> pointP, vector<ofPoint> textureP, ofTexture &tex, bool _3d = false);

	static void drawQuads( vector<ofPoint> pointP, bool _3d = false);
